    ...
    <section className={classes.section}>
      <svg id="500_Bill" viewBox="-8.5 9.5 560 250">
        ...
        <g id="light-glow" clipPath="url(#circle-mask)">
          ...
          />
          <circle className={classNames(classes.glow, classes.glowOuter1)} opacity=".35" fill="#F00" cx="378.7" cy="109.8" r="55.2" />
          <circle className={classNames(classes.glow, classes.glowInner)} opacity=".35" fill="#F00" cx="378.7" cy="109.8" r="28.3" />
        </g>
        <g id="Bill">
          <path
            id="Body"
          ...
          <g id="Ears">
            <g id="Ear-right">
              ...
              <path
                ...
                className={classes.billHighlight}
                fill="#F00"
                fillOpacity="0.7"
                d="M281.8 142.2c-5.5 0-9.9-4.4-9.9-9.9s4.4-9.9 9.9-9.9 9.9 4.4 9.9 9.9-4.5 9.9-9.9 9.9z"
              />
          ...
          <g id="Eyes" fill="#263D52">
            <circle className={classes.eyesLeft} style={{ transformOrigin: '228.391px 126.333px' }} cx="228.4" cy="126.3" r="5.9" />
            <circle className={classes.eyesRight} style={{ transformOrigin: '266.289px 126.333px' }} cx="266.3" cy="126.3" r="5.9" />
          </g>
        ...
        <g id="smokes" fill="#D5DADB">
          <use xlinkHref="#ember-emit" className={classes.emittedEmber} />
          <use
            xlinkHref="#ember-emit"
            className={classNames(classes.emittedEmber, classes.emittedEmberAlt)}
            style={{ animationDelay: '-0.5s' }}
          />
          <use xlinkHref="#ember-emit" className={classes.emittedEmber} style={{ animationDelay: '-0.7s' }} />
          <use xlinkHref="#ember-emit" className={classNames(classes.emittedEmber, classes.emittedEmberAlt)} style={{ animationDelay: '-1s' }} />
          <circle
            id="smoke-base-1"
          ...
          />
          <circle
            className={classNames(classes.smoke, classes.smokeBase3)}
          ...
          <circle
            ...
            className={classNames(classes.smoke, classes.smokeBase2)}
            cx="480"
            cy="70.4"
            r="8"
          />
          <circle
            ...
            className={classNames(classes.emittedEmber, classes.smokeFloat2)}
            fillOpacity=".8"
            cx="464.9"
            cy="53.3"
            r="5.4"
          ...
          <circle
            ...
            className={classNames(classes.emittedEmber, classes.emittedEmberAlt, classes.smokeFloat1)}
            fillOpacity=".8"
            cx="469.4"
            cy="62.3"
            r="7.6"
          ...
          <circle
            ...
            className={classNames(classes.emittedEmber, classes.smokeFloat3)}
            fillOpacity=".8"
            cx="471.1"
            cy="47.9"
            r="4.5"
          ...
          <circle
            ...
            className={classNames(classes.emittedEmber, classes.smokeFloat5)}
            fillOpacity=".3"
            cx="470.4"
            cy="28.2"
            r="2.5"
          ...
          <circle
            ...
            className={classNames(classes.emittedEmber, classes.emittedEmberAlt, classes.smokeFloat4)}
            fillOpacity=".6"
            cx="467.2"
            cy="36.3"
            r="3.2"
        ...
        <g id="fire" clipPath="url(#flame-mask)">
          <path
            ...
            className={classNames(classes.flameFront, classes.flameBlack)}
            fill="#D14D40"
            d="M456.3 93l14-24.8L485.1 93z"
          />
          <path
            style={{ MozTransformOrigin: '462.55px 93px' }}
            className={classNames(classes.flameFront, classes.flameFrontLeft)}
            fill="#FB6A4F"
            d="M458.7 79l-5.2 14h18.1z"
          />
          <path
            style={{ MozTransformOrigin: ' 479.162px 93px' }}
            className={classNames(classes.flameFront, classes.animDelay1, classes.flameFrontRight)}
            fill="#FB6A4F"
            d="M497 93l-9.2-35.5L461.3 93z"
          />
          <path
            style={{ MozTransformOrigin: '461.677px 97px' }}
            className={classNames(classes.flameInner, classes.flameInnerLeft)}
            fill="#FFD657"
            d="M456.7 97l5.8-12.4 4.1 12.4z"
          />
          <path
           id={classes.flameInnerLeft}
            style={{ MozTransformOrigin: '476.268px 97px' }}
            className={classNames(classes.flameInner, classes.flameInnerRight)}
            fill="#FFD657"
            d="M492.1 97L484 77.3 460.4 97z"
          />
        </g>
      </svg>
      <h2 style={{ textAlign: 'center' }}>Woops! Something went wrong</h2>
    </section>
  );
}
